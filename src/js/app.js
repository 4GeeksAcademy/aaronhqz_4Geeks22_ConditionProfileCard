...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            <li><a href="https://twitter.com/${twitterHandle}"><i class="fa-brands fa-x-twitter"></i></a></li>
            <li><a href="https://github.com/${githubHandle}"><i class="fa-brands fa-github"></i></a></li>
            <li><a href="https://linkedin.com/in/${linkedinHandle}"><i class="fa-brands fa-linkedin"></i></a></li>
